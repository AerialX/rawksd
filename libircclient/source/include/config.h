...
#define strnstr(x, y, z) strstr(x, y)
#define gethostbyname net_gethostbyname
#define gethostname(x, y) (strncpy(x, "rawkd", y) ? 0 : -1)

// This will cause any DCC attempts to fail. Fucking live with it or implement the damn function yourself
