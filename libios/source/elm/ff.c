...
#include <elm/ff.h>		/* FatFs configurations and declarations */
#include <elm/diskio.h>		/* Declarations of low level disk I/O functions */
#include <elm.h>
...
FRESULT dir_next (	/* FR_OK:Succeeded, FR_NO_FILE:End of table, FR_DENIED:EOT and could not streach */
	DIR *dj,		/* Pointer to directory object */
	int streach	/* 0: Do not streach table, 1: Streach table if needed */
)
{
	DWORD clst;
	WORD i;
...
)
{
	...
	return 1;					/* The LFN entry matched */
}
...
)
{
	...
	do {
		...
		res = dir_next(dj, 1);	/* Next entry with table streach */
	} while (res == FR_OK);
