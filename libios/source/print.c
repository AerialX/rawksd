...
int _vsprintf(char *buf, const char *fmt, va_list args)
{
	...
	rv = do_printf(fmt, args, _vsprintf_help, (void *)buf);
	buf[rv] = '\0';
	return rv;
}
/*****************************************************************************
...
*****************************************************************************/
int _vprintf_help(unsigned c, void **ptr)
{
	putchar(c);
	return 0 ;
}
...
{
	return do_printf(fmt, args, _vprintf_help, NULL);
}
/*****************************************************************************
*****************************************************************************/
