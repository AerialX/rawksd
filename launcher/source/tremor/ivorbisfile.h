...
extern int mem_open(char * ogg, int size); // use this to open a file in memory. 
extern int mem_close(int fd); // use this to close a file in memory in case you cannot call to ov_clear() function to do it
