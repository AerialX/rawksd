...
static const u32 ftable_16[256] = {
...
static const u32 ftable_24[256] = {
...
static const u32 rtable_16[256] = {
...
static const u32 rtable_24[256] = {
...
/* Last Round */
    y[0]=fkey[k++]^fbsub[(u8)x[0]]^
         (fbsub[(u8)(x[1]>>8)]<<8)^
         (fbsub[(u8)(x[2]>>16)]<<16)^
         (fbsub[x[3]>>24]<<24);
    y[1]=fkey[k++]^fbsub[(u8)x[1]]^
         (fbsub[(u8)(x[2]>>8)]<<8)^
         (fbsub[(u8)(x[3]>>16)]<<16)^
         (fbsub[x[0]>>24]<<24);
    y[2]=fkey[k++]^fbsub[(u8)x[2]]^
         (fbsub[(u8)(x[3]>>8)]<<8)^
         (fbsub[(u8)(x[0]>>16)]<<16)^
         (fbsub[x[1]>>24]<<24);
    y[3]=fkey[k++]^fbsub[(u8)x[3]]^
         (fbsub[(u8)(x[0]>>8)]<<8)^
         (fbsub[(u8)(x[1]>>16)]<<16)^
         (fbsub[x[2]>>24]<<24);
...
/* Last Round */
    ...
    y[0]=/*rkey[k++]^*/rbsub[(u8)x[0]]^
         (rbsub[(u8)(x[3]>>8)]<<8)^
         (rbsub[(u8)(x[2]>>16)]<<16)^
         (rbsub[x[1]>>24]<<24);
    y[1]=/*rkey[k++]^*/rbsub[(u8)x[1]]^
         (rbsub[(u8)(x[0]>>8)]<<8)^
         (rbsub[(u8)(x[3]>>16)]<<16)^
         (rbsub[x[2]>>24]<<24);
